// ============================================================================
// ufpr-abntyp - Camada institucional UFPR sobre ABNTyp
// ============================================================================
//
// Copyright (c) 2024-2026 Esdras
// Licenca: MIT
//
// Este pacote filho reutiliza o ABNTyp (https://github.com/3sdras/abntyp)
// e aplica personalizações institucionais para a UFPR.
//
// O projeto original ABNTyp foi inspirado no abnTeX2 (https://github.com/abntex/abntex2),
...
#import "src/institutions/ufpr/cover.typ": *
#import "src/institutions/ufpr/metadata.typ": *

// Presets institucionais
#import "src/presets/ufpr.typ": *
