...
#let textual(usar-numeracao-verso: false) = {
  counter(page).update(1)
  if usar-numeracao-verso {
    // Fallback: Typst atual não oferece alinhamento alternado nativo por paridade.
    // Mantém numeração ativa para refs por página e compatibilidade do template.
