...
#let with-abnt-setup(
  ...
  // Elementos gráficos: título acima com separador em dois-pontos
  // e tabelas automaticamente alinhadas à esquerda com texto justificado.
  ...
  // Seção terciária (nível 3): Minúsculas, regular
